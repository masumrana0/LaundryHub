  ...
  return (
    <div className={` container mx-auto text-center mt-20`}>
      <div className="md:mb-10">
        <p className="md:text-xl text-sm text-center font-thin tracking-tighter">
          We Clean EveryThing
        </p>
      ...
      <div className="flex flex-col md:flex-row mx-auto items-center  ">
        {/* first*/}
        <div className="group p-10  relative">
          ...
          <h3 className="font-semibold md:text-xl text-sm mb-2">
